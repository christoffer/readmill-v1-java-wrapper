...
public class ReadmillUserTests extends ReadmillTestCase {
	...
	public void testInitFromJSON() throws JSONException {
		...
		assertEquals(
				"avatarUrl: ",
				"http://static.readmill.com/avatars/d281aa934d75016e9f60c2db7e4a55e4-medium.png?1308255920",
				user.getAvatarUrl());
	...
	public void testToConvertToJSON() throws JSONException,
		...
		user.setAvatarUrl("http://static.readmill.com/avatars/d281aa934d75016e9f60c2db7e4a55e4-medium.png?1308255920");
